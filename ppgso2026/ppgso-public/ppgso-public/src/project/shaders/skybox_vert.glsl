...
uniform float skyboxYOffset;

void main() {
    // Posun vzorkovacieho vektora po osi Y (posunie horizont hore/dolu)
    TexCoords = vec3(Position.x, Position.y - skyboxYOffset, Position.z);
